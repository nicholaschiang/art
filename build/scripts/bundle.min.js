...
function draw(canvas) {
    ...
    var painter = new Worker('scripts/painter.js');
    painter.postMessage({
        image: image,
        color: '#FF0000',
        probs: 0.4,
    ...
    painter.onmessage = function (image) {
        return ctx.putImageData(convert(image.data, ctx.createImageData(canvas.width, canvas.height)), 0, 0);
    };
};
...
function construct(params) {
    if (!params.width || !params.height) throw new Error('Construct() needs ' + 'a valid height and width.');
...
var Pixel = function () {
    ...
    _createClass(Pixel, [{
        ...
        value: function toString() {
            return 'Pixel at (' + this.row + ', ' + this.col + ') colored ' + RGBToHex(this);
        }
    }]);
